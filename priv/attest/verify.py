#!/usr/bin/env python3
"""Verify a shem attest bundle. Python 3 stdlib only. See README.txt."""
...
def main(argv):
    ...
    if bh:
        print(f"beam head {bh[:12]}… (cross-check with `shem` on the source system; not recomputable here)")
